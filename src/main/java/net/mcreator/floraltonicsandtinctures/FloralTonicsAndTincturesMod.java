package net.mcreator.floraltonicsandtinctures;
...
import net.mcreator.floraltonicsandtinctures.init.FloralTonicsAndTincturesModTabs;
...
@Mod("floral_tonics_and_tinctures")
public class FloralTonicsAndTincturesMod {
	public static final Logger LOGGER = LogManager.getLogger(FloralTonicsAndTincturesMod.class);
	public static final String MODID = "floral_tonics_and_tinctures";

	public FloralTonicsAndTincturesMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		FloralTonicsAndTincturesModBlocks.REGISTRY.register(modEventBus);

		FloralTonicsAndTincturesModItems.register(modEventBus);

		FloralTonicsAndTincturesModTabs.REGISTRY.register(modEventBus);

		FloralTonicsAndTincturesModPotions.REGISTRY.register(modEventBus);
		FloralTonicsAndTincturesModMobEffects.REGISTRY.register(modEventBus);
		FloralTonicsAndTincturesModEnchantments.REGISTRY.register(modEventBus);
		FloralTonicsAndTincturesModMenus.REGISTRY.register(modEventBus);
